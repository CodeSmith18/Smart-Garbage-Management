            ...
            <section className="w-full overflow-hidden dark:bg-gray-900">
                <div className="flex flex-col">
                    ...
                    <div className="xl:w-[80%] lg:w-[90%] md:w-[90%] sm:w-[92%] xs:w-[90%] mx-auto flex flex-col gap-4 items-center relative lg:-top-8 md:-top-6 sm:-top-4 xs:-top-4">
                        <p className="text-gray-700 dark:text-gray-400 text-md px-4 text-center">
                            ...
                            <div className="w-full flex-1 px-2">
                                <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                                    <div className="flex flex-col py-2">
                                        ...
                                        <dd className="text-lg font-semibold">User</dd>
                                    </div>
                                    <div className="flex flex-col py-2">
                                    ...
                                    <div className="flex flex-col py-2">
                                        ...
                                        <dd className="text-lg font-semibold">XX/XX/XXXX</dd>
                                    </div>
                                    <div className="flex flex-col py-2">
                            ...
                            <div className="w-full flex-1 px-2">
                                <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                                    <div className="flex flex-col py-2">
                                        ...
                                        <dd className="text-lg font-semibold">Ranchi, India</dd>
                                    </div>
                                    <div className="flex flex-col py-2">
                                        <dt className="text-gray-500 md:text-lg dark:text-gray-400">Phone Number</dt>
                                        <dd className="text-lg font-semibold">+911234567890</dd>
                                    </div>
                                    <div className="flex flex-col py-2">
                                        <dt className="text-gray-500 md:text-lg dark:text-gray-400">Email</dt>
                                        <dd className="text-lg font-semibold">user@gmail.com</dd>
                                    </div>
                                    {/* <div className="flex flex-col py-2">
                                        <dt className="text-gray-500 md:text-lg dark:text-gray-400">Website</dt>
